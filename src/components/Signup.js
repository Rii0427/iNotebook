    ...
    return (
        <div className='container mt-2'>
            ...
            <form onSubmit={handleSubmit}>
                <div className="my-3">
                    <label htmlFor="name" className="form-label">Email Full Name</label>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" className="form-control" value={credentials.cpassword} onChange={onChange} id="password" name="cpassword" minLength={5} required />
                </div>
